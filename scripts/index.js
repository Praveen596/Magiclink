...
x = setInterval(function() {
  ...
  let w = (c.width = window.innerWidth),
    ...
    hh = h / 2,
    opts = {
      strings: ['HAPPIEST BIRTHDAY!','', config.name ,'','', 'Enjoy your special day','to the fullest', 'Wishing you a','fantastic birthday ','and a wonderful','year ahead.',],
      charSize: 20,
      charSpacing: 20,
      lineHeight: 25,
